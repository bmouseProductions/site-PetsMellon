          ...
          <Container fluid  className=''>
            ...
            <Navbar.Offcanvas id={`offcanvasNavbar-expand-${expand}`} aria-labelledby={`offcanvasNavbarLabel-expand-${expand}`} placement="end"  style={{backgroundColor:'#EF2E72'}}>
              ...
              <Offcanvas.Body className='d-flex  menu-xxl'>
                <Nav className="menu">
                  <Link to="/site/en" className='link-white text-muted'>Home</Link >
                  <Link to="/site/conheca-en" className='link-white'>Get to know us</Link>
                  <Link to="/site/produtos-en" className='link-white'>Products</Link>
                  <Link to="/site/servicos-en" className='link-white'>Services</Link>
                  <Link to="/site/customizacoes-en" className='link-white'>Customizations</Link>
                  <Link to="/site/parceria-en" className='link-white'>Partnership</Link>
                  <a href='https://patense.com.br/' target={'_blank'} className='link-white'>Patense</a>
                   {/* <Link to="/blog" className='link-white'>Blog</Link> */}
                  <NavDropdown title="Sustainability" id={`offcanvasNavbarDropdown-expand-${expand}`} className='link-white' style={{fontSize:'17.6px'}}>
                    <NavDropdown.Item>
                  ...
                  <Link to="/site/contato" className='text-white rounded-1 text-center p-2 ps-3 pe-3' style={{backgroundColor:"#F58525"}}>Contact</Link>
                </Nav>
              </Offcanvas.Body>
            </Navbar.Offcanvas>
          </Container>
