        ...
        <Parceiro>
          <Row className="">
            <img
              src={ParceiroImg}
              alt=""
              className="rounded-5 img-fluid m-auto img-parceiro"
            />
          </Row>
          <Row className="">
            <p className="text-muted">
              A Pets Mellon trabalha como co-packer para sua marca. Estamos
              empenhados em fornecer um padrão de qualidade excepcional para o
              seu produto finalizado, garantindo uma experiência diferenciada e
              exclusiva para seus clientes. Por isso, trabalhamos em estreita
              colaboração com nossos parceiros para encontrar soluções
              personalizadas que atendam às suas necessidades específicas e
              garantam sua total satisfação.
            </p>
            <Form
