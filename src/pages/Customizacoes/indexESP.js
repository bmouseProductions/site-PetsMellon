        ...
        <div className='bg-light fade-in'>
            ...
            <Customizacao className='bg-light'>
                <div className='text-center mt-3 d-flex flex-column align-items-center justify-content-center' style={{backgroundColor:'transparent'}}>
                        ...
                        <p className='text-dark'>Ofrecemos un servicio personalizado. Esto significa que cada producto se modifica o adapta según las especificaciones de cada cliente. Participamos plenamente en sus proyectos, desde los ingredientes hasta las tecnologías a utilizar, aportando soluciones rápidas y eficaces y manteniendo absoluta confidencialidad en cada proyecto.</p>
                </div>
                <Row className=' w-100'>
                    <Col>
                        ...
                        <Card style={{ width:'100%',height:'22rem',backgroundColor:'#491A76'}}  className='text-center border-0 mt-4 p-3'>
                            <Card.Body className='d-flex flex-column align-items-start justify-content-start w-100 p-2'>
                                ...
                                <div className='mt-3 d-flex flex-column gap-3 text-white align-items-start w-100'>
                                    ...
                                    <li>√ Conservante Natural</li> 
                                    <li>√ Tinte Natural</li> 
                                    <li>√ Selección de sabores (sin cereales añadidos, sin azúcar, sin pesticidas, sin soja)</li> 
                                    <li>√ Con Prebióticos y Probióticos añadidos.</li> 
                                    <li># paquetes de 30g a 1,0kg</li>
                                </div>
                            </Card.Body>
