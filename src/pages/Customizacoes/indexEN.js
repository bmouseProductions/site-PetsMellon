      ...
      <Customizacao className="bg-light">
        ...
        >
          ...
          <p className="text-dark">
            We offer a customized service. This means that each product is
            modified or adapted according to each client's specifications. We
            participate fully in their projects, from the ingredients to the
            technologies to be used, providing fast and effective solutions and
            maintaining absolute secrecy in each project.
          </p>
        </div>
        <Row className=" w-100">
          <Col>
            ...
            >
              <Card.Body className="d-flex align-items-start flex-column justify-content-start w-100 p-2">
                ...
                <h5 className="text-white">Examples:</h5>
            ...
            >
              <Card.Body className="d-flex flex-column align-items-start justify-content-start w-100 p-2">
                ...
                <div className="mt-3 d-flex flex-column gap-3 text-white align-items-start w-100">
                  ...
                  <li>
                    √ Natural Palatabilizer (no additives or preservatives)
                  </li>
            ...
            >
              <Card.Body className="d-flex flex-column align-items-start justify-content-start w-100 p-2">
                ...
                <div className="mt-3 d-flex flex-column gap-2 text-white align-items-start w-100">
                  ...
                  <li>
                    √ Selection Palatabilizer (no added cereals, sugar, no
                    pesticides, soy free)
                  </li>
                  <li>√ With added Prebiotics and Probiotics.</li>
                  <li># packages from 30g to 1.0kg</li>
                </div>
              </Card.Body>
            </Card>
          </Col>
