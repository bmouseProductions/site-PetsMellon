                   ...
                   <div className='w-100 d-flex flex-column mt-5 blog-lg'>
                            ...
                            <Row className='w-100 m-0 gap-5'>
                                <Col sm={12} className='d-flex flex-column gap-3' data-aos="zoom-in">
                                    ...
                                    <div className='d-flex align-items-center gap-3'>
                                        <Link to="/site/single-page" style={{color:'#f52369'}}>Leia Mais</Link>
                                ...
                                <Col sm={12} className=' d-flex flex-column gap-3' data-aos="zoom-in">
                                    ...
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti, excepturi nemo blanditiis inventore quis, mollitia dignissimos dolore atque at perferendis laborum natus officia molestiae beatae quod soluta minus, consequuntur sequi.</p>
                                    <div className='d-flex align-items-center gap-3'>
                                        <a href="" style={{color:'#f52369'}}>Leia Mais</a>
                                        <IoPawOutline size={25} color={'#f52369'}/>
                                    </div>
                                    <img src={Separator} alt="" />
                                </Col>
                        ...
                        <div className='w-100 blog-width  mb-3' data-aos="fade-left">
                            <Row className='w-100 m-0 gap-3'>
                                <Col sm={12} className='p-4 rounded-3 ' style={{backgroundColor:'#e7e8e5'}}>
                                    <h2 className=''style={{color:'#f58525'}}>Buscar</h2>
                                    <div className='d-flex align-items-center'>
                                        <input type="search" name="" id="" placeholder='buscar' className='w-100 p-3 rounded-3 border-0 outline-none'/>
                                        <Button className='border-0 btn-light p-3 ms-2' style={{backgroundColor:'#f52369'}}><AiOutlineSearch size={25} color={'#fff'}/></Button>
                                    </div>
                                </Col>
                                <Col sm={12} className='d-flex flex-column p-4 rounded-3 gap-3'  style={{backgroundColor:'#e7e8e5'}} >
                                    <h2 className=''style={{color:'#f58525'}}>Categoria</h2>
                                    <a href="" style={{color:'#4a1976'}}>Dog 1</a>
                                    <img src={Separator} alt="" />
                                    <a href="" style={{color:'#4a1976'}}>Dog 2</a>
                                    <img src={Separator} alt="" />
                                    <a href="" style={{color:'#4a1976'}}>Dog 3</a>
                                    <img src={Separator} alt="" />
                                    <a href="" style={{color:'#4a1976'}}>Dog 4</a>
                                    <img src={Separator} alt="" />
                                </Col>
                                <Col sm={12} className='d-flex gap-5 flex-column p-4 rounded-3'  style={{backgroundColor:'#e7e8e5'}}>
                                    <h2 className='' style={{color:'#f58525'}}>Posts Recentes</h2>
                                    <div className='rounded-3 d-flex flex-column gap-3' data-aos="fade-up">
                                        <img src="https://kutto.netlify.app/img/blog/rc_post_thumb01.jpg" alt="" className='w-100 rounded-3'/>
