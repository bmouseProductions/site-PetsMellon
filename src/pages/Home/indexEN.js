...
export const HomeEN = ()=>{
    ...
    function redirectCustom(){
        navigate(`/site/customizacoes-en`)
    }

    function redirectConheca(){
        navigate(`/site/conheca-en`)
    }

    function redirectProdutos(){
        navigate(`/site/produtos-en`)
    }
        ...
        <div className='bg-light fade-in'>
            ...
            <Container className=''>
                <Dados className='text-white' data-aos='fade-up' data-aos-duration="2000">
                    <Card className='d-flex align-items-center justify-content-center p-2 rounded-0 rounded-top border-0 border-bottom-1 border-dados-radius-start' style={{backgroundColor:'#F52369'}}>
                        <Card.Body className='d-flex align-items-center justify-content-center gap-3 text-center' style={{fontSize:'0.8rem'}}> <TfiLocationPin size={36}/><Link to="/site/contato-en" className='text-white'>Contact</Link></Card.Body>
                    </Card>
                    ...
                    <Card className='d-flex align-items-center justify-content-center p-2 rounded-0 border-0 border-dados' style={{backgroundColor:'#491A76'}}>
                        <Card.Body className='d-flex align-items-center justify-content-center gap-3'><GiSittingDog size={36}/><Link to="/site/customizacoes-en"  className='text-white'>Custom Formulas</Link></Card.Body>
                    </Card>

                    <Card className='d-flex align-items-center justify-content-center p-2 rounded-0 border-0 border-dados' style={{backgroundColor:'#491A76'}}>
                        <Card.Body className='d-flex align-items-center justify-content-center gap-3'><FaCat size={36}/><Link to="/site/produtos-en"  className='text-white'>Product types</Link></Card.Body>
                    </Card>
                    <Card className='d-flex align-items-center justify-content-center p-2 border-0 rounded-0 rounded-bottom border-dados border-dados-radius-end' style={{backgroundColor:'#F52369',}}>
                        <Card.Body className='d-flex align-items-center justify-content-center gap-3'> <SiMaterialdesignicons size={36}/><Link to="/site/servicos-en"  className='text-white'>Everything for your brand</Link></Card.Body>
                    </Card>
                </Dados>
                    ...
                    <Card style={{ width: '100%' }} className='text-left border-0 mt-4 p-0 m-0 mb-4'>
                        <Card.Body className='w-100 p-0'>
                            <div className='d-flex text-center gap-2'>
                                <h1 className="mb-2 p-0 m-0 text-left" style={{color:'#FF9200'}}>About </h1>
                                <h1 className="mb-2 p-0 m-0 text-muted ">Us</h1>
                            </div>
                            <Card.Text className='text-dark lh-6 p-0'>A new business, but for 50 years with the same quality! Focused on products for pets, our new unit brings quality and sustainability, already marked in the DNA of the Patense Group. We work as Copackers for major brands in Brazil and the world, producing numerous products for dogs and cats with	excellence.</Card.Text>
                            <Button onClick={()=> redirectConheca()} className='w-100 border-0 mb-3 p-3 mt-4 text-center m-auto shadow-lg'style={{backgroundColor:'#491A76'}}><h4>Learn More</h4></Button>
                        </Card.Body>
                    </Card>
                </Sobre> 
            </Container>
            ...
            <Container>     
                <Customizacao className=''>
                    ...
                    <Cards>
                        ...
                        <Button data-aos='fade-up' data-aos-duration="2000" onClick={()=> redirectCustom()} className='w-100 border-0 mb-3 p-3 mt-4 text-center m-auto shadow-lg'style={{backgroundColor:'#F58525'}}><h4>Learn More</h4></Button>
                    </Cards>
                </Customizacao>
            </Container>
            ...
            <Certificacoes className='bg-white'>
                    <div className='d-flex flex-column text-center gap-2' data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
                        <h1 className="mb-2 p-0 m-0 text-left" style={{color:'#4A1976'}}>Ongoing </h1>
