...
export const HomeESP = () => {
  ...
  function redirectCustom() {
    navigate(`/customizacoes-esp`);
  }

  function redirectConheca() {
    navigate(`/conheca-esp`);
  }

  function redirectProdutos() {
    navigate(`/produtos-esp`);
  }
        ...
        >
          ...
          >
            ...
            >
              ...
              <Link to="/contato-esp" className="text-white">
                Contacto
              </Link>
            </Card.Body>
          </Card>
          ...
          >
            <Card.Body className="d-flex align-items-center justify-content-center gap-3">
              ...
              <Link to="/customizacoes-esp" className="text-white">
          ...
          >
            <Card.Body className="d-flex align-items-center justify-content-center gap-3">
              <FaCat size={36} />
              <Link to="/produtos-esp" className="text-white">
                Tipos de productos
              </Link>
            </Card.Body>
          </Card>
          ...
          >
            <Card.Body className="d-flex align-items-center justify-content-center gap-3">
              ...
              <Link to="/servicos-esp" className="text-white">
                Todo para tu Marca
              </Link>
            </Card.Body>
          </Card>
