...
export const Home = ()=>{
    ...
    function redirectCustom(){
        navigate(`/site/customizacoes`)
    }

    function redirectConheca(){
        navigate(`/site/conheca`)
    }

    function redirectProdutos(){
        navigate(`/site/produtos`)
    }
        ...
        <div className='bg-light fade-in'>
            ...
            <Container className=''>
                <Dados className='text-white' data-aos='fade-up' data-aos-duration="2000">
                    <Card className='d-flex align-items-center justify-content-center p-2 rounded-0 rounded-top border-0 border-bottom-1 border-dados-radius-start' style={{backgroundColor:'#F52369'}}>
                        <Card.Body className='d-flex align-items-center justify-content-center gap-3 text-center' style={{fontSize:'0.8rem'}}> <TfiLocationPin size={36}/><Link to="/site/contato" className='text-white'>Contato</Link></Card.Body>
                    </Card>
                    ...
                    <Card className='d-flex align-items-center justify-content-center p-2 rounded-0 border-0 border-dados' style={{backgroundColor:'#491A76'}}>
                        <Card.Body className='d-flex align-items-center justify-content-center gap-3'><GiSittingDog size={36}/><Link to="/site/customizacoes"  className='text-white'>Fórmulas Customizadas</Link></Card.Body>
                    </Card>

                    <Card className='d-flex align-items-center justify-content-center p-2 rounded-0 border-0 border-dados' style={{backgroundColor:'#491A76'}}>
                        <Card.Body className='d-flex align-items-center justify-content-center gap-3'><FaCat size={36}/><Link to="/site/produtos"  className='text-white'>Tipos de Produtos</Link></Card.Body>
                    </Card>
                    <Card className='d-flex align-items-center justify-content-center p-2 border-0 rounded-0 rounded-bottom border-dados border-dados-radius-end' style={{backgroundColor:'#F52369',}}>
                        <Card.Body className='d-flex align-items-center justify-content-center gap-3'> <SiMaterialdesignicons size={36}/><Link to="/site/servicos"  className='text-white'>Tudo para a sua Marca</Link></Card.Body>
                    </Card>
                </Dados>
                <Sobre className='w-100' data-aos='fade-up' data-aos-duration="2000">
                    ...
                    <Card style={{ width: '100%' }} className='text-left border-0 mt-4 p-0 m-0 mb-4'>
                        <Card.Body className='w-100 p-0'>
                            ...
                            <Card.Text className='text-dark lh-6 p-0'>Um novo negócio, mas há 50 anos com a mesma qualidade! Voltada para os produtos pet, nossa nova unidade traz a qualidade, inovação e sustentabilidade já marcados no DNA do Grupo Patense. Trabalhamos como co-packers para grandes marcas do Brasil e do mundo, produzindo, com excelência, inúmeros produtos para cães e gatos.</Card.Text>
                            <Button onClick={()=> redirectConheca()} className='w-100 border-0 mb-3 p-3 mt-4 text-center m-auto shadow-lg'style={{backgroundColor:'#491A76'}}><h4>Saiba Mais</h4></Button>
                        </Card.Body>
                    </Card>
                </Sobre> 
            </Container>
            <Produtos>
                ...
                <ProdutoDescricao data-aos='fade-up' data-aos-duration="2000">
                    ...
                    <Button onClick={()=> redirectProdutos()} className='w-100 border-0 mb-3 p-3 mt-4 text-center m-auto shadow-lg'style={{backgroundColor:'#491A76'}}><h4>Ver Todos</h4></Button>
                </ProdutoDescricao>
            </Produtos>
            <Container>     
                <Customizacao className=''>
                    ...
                    <Cards>
                        ...
                        <Card data-aos='fade-up' data-aos-duration="2000" style={{ width: '100%' }} className='text-center border-0 mt-4 p-3 shadow-lg'>
                            <Card.Body className='d-flex align-items-center justify-content-start gap-3 w-100 p-2'>
                                <FaPaw className='' size={30} color={'#fff'}/>
                                <h3 className='text-white'>Linha High Premium(Linha Super Premium)</h3>
                            </Card.Body>
                        </Card>
                        <Button data-aos='fade-up' data-aos-duration="2000" onClick={()=> redirectCustom()} className='w-100 border-0 mb-3 p-3 mt-4 text-center m-auto shadow-lg'style={{backgroundColor:'#F58525'}}><h4>Saiba Mais</h4></Button>
                    </Cards>
                </Customizacao>
            </Container>
