    ...
    <div className="bg-light d-flex flex-column justify-content-between fade-in w-100 ">
          ...
          >
            <Card.Body className="w-100 p-0">
              ...
              <Card.Text className="text-dark lh-6 p-0">
                ¡Un negocio nuevo, pero desde hace 50 años con la misma calidad!
                Enfocada en productos PET, nuestra nueva unidad trae la calidad,
                innovación y sustentabilidad ya marcadas en el ADN del Grupo
                Patense. Trabajamos como Copackers para las principales marcas
                de Brasil y del mundo, produciendo con excelencia numerosos
      ...
      <div className="p-0 m-0" style={{ backgroundColor: "#f58525" }}>
        <Row className="gap-3 p-3 d-flex justify-content-center w-100 m-0">
          <h1 className="text-white text-center">Mascotas de calidad Mellón</h1>
          <Col
            sm={12}
            lg={5}
          ...
          >
            ...
            <div className="d-flex flex-column gap-2 text-white">
              <span>
                <strong style={{ color: "#f58525" }}>Zona Industrial: </strong>{" "}
                7500 m
              </span>
              <span>
              ...
              <span>
                <strong style={{ color: "#f58525" }}>Ciudad:</strong>{" "}
                Votuporanga - SP
              </span>
            </div>
            <h3 className="text-center" style={{ color: "#f58525" }}>
            ...
            <div className="d-flex flex-column gap-2  text-white">
              <span>
                <strong style={{ color: "#f58525" }}>Snacks (Snacks): </strong>{" "}
                1500 ton/año
              </span>
              <span>
                <strong style={{ color: "#f58525" }}>
                  Body parts (Bovinos, Porcinos, Aves y Pescados):{" "}
                </strong>{" "}
                2.000 ton/año
              </span>
              <span>
                <strong style={{ color: "#f58525" }}>
                  Alimentos húmedos (enlatados/en bolsa):
                </strong>{" "}
                4.800 ton/año
              </span>
          ...
          >
            ...
            <div className="d-flex flex-column text-white gap-2">
              <span>
                ...
                Producción y comercialización de alimentos completos e
                incompletos para mascotas.
              </span>
              <span>
                <AiOutlineCheck size={20} />
                Producción y comercialización de ingredientes para la
                alimentación animal.
              </span>
              <span>
                <AiOutlineCheck size={20} /> Snacks para perros y gatos.
              </span>
              <span>
                <strong style={{ color: "#f58525" }}>Body parts:</strong>
                bovino, porcino, pescado, fémur, espinilla, costilla, rótula,
                varilla, tráquea, esófago, orejas...
              </span>
              <span>
              ...
              <span>
                <strong style={{ color: "#f58525" }}>Enlatados:</strong> 100g y
                280g
              </span>
              <span>
                <strong style={{ color: "#f58525" }}>Pouch: </strong>85g y 100g
              </span>
            </div>
          </Col>
        </Row>
