      ...
      <Produtos>
        ...
        <ProdutoDescricao data-aos="fade-up" data-aos-duration="2000">
          ...
          <p className="text-white">
            ...
            very high-quality resources to our partners. All our products are
      ...
      <Container>
        <Row className="mt-2 mb-5 ">
          <div className="text-center mt-5 d-flex flex-row justify-content-center mb-5">
            <h1 className="me-3 text-muted">Product Types</h1>
          ...
          <Col sm={12} lg={4} data-aos="zoom-in-up">
            <Card className="p-0 m-0 border-0 ">
              ...
              <Card.Body className="">
                ...
                <p className="fs-5">
                  Classified as chewable products, Body Parts are products based
                  on animal by-products and can include ingredients of vegetable
                  origin. They are intended exclusively for companion animals,
                  for the purpose of amusement or pleasure, containing
                  negligible nutritional value. As an example, we have the
                  natural ears and small, medium and large bones of cattle and
                  pigs.
                </p>
              </Card.Body>
            </Card>
          ...
          <Col sm={12} lg={4} data-aos="zoom-in-up">
            <Card className="p-0 m-0 border-0">
              ...
              <Card.Body className="">
                <h3>Snacks</h3>
                <p className="fs-5">
                  Snacks are identified as specific foods. They are products
                  composed of ingredients, raw materials or additives intended
                  exclusively for the feeding of pets for the purpose of
                  pleasure, prize or reward, and may have specific properties.
                  We have as an example the steaks and snacks in general.
                </p>
              </Card.Body>
            </Card>
          </Col>
          <Col sm={12} lg={4} data-aos="zoom-in-up">
            <Card className="p-0 m-0 border-0">
              ...
              <Card.Body className="">
                <h3>Wet feed</h3>
                <p className="fs-5">
                  Canned and pouch foods are classified as complete and
                  incomplete foods, usually differing only in the packaging
                  presented. These foods are capable of fully meeting
                  nutritional requirements and may possess specific or
                  functional properties. They are composed of ingredients, raw
                  materials, and additives intended exclusively for pet feeding.
                  In addition to these, we are starting to produce lickables,
                  which aim to introduce a new concept of snacks for felines and
                  have garnered significant demand from our partners and
                  customers.
                </p>
              </Card.Body>
            </Card>
