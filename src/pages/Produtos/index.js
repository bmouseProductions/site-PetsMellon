          ...
          <Col sm={12} lg={4} data-aos="zoom-in-up">
            <Card className="p-0 m-0 border-0 ">
              ...
              <Card.Body className="">
                ...
                <p className="fs-5">
                  Classificados como produtos mastigáveis, os Body Parts são
                  produtos à base de subprodutos de origem animal, podendo
                  abarcar ingredientes de origem vegetal. São destinados
                  exclusivamente aos animais de companhia, com a finalidade de
                  diversão ou agrado, contendo valor nutricional insignificante.
                  Como exemplo temos as orelhas naturais e os ossos pequenos,
                  médios e grandes de bovinos e suínos.
                </p>
              </Card.Body>
            </Card>
          </Col>
          <Col sm={12} lg={4} data-aos="zoom-in-up">
            <Card className="p-0 m-0 border-0">
              ...
              <Card.Body className="">
                <h3>Snacks</h3>
                <p className="fs-5">
                  Os snacks são identificados como alimentos específicos. São
                  produtos compostos por ingredientes, matérias-primas ou
                  aditivos destinados exclusivamente à alimentação de animais de
                  companhia com finalidade de agrado, prêmio ou recompensa,
                  podendo possuir propriedades específicas. Temos como exemplo
          ...
          <Col sm={12} lg={4} data-aos="zoom-in-up">
            <Card className="p-0 m-0 border-0">
              ...
              <Card.Body className="">
                <h3>Ração Úmida</h3>
                <p className="fs-5">
                  São classificados como alimentos completos e incompletos, os
                  enlatados e Pouchs geralmente se diferenciam apenas na
                  embalagem apresentada. São alimentos capazes de atender
                  integralmente as exigências nutricionais, podendo possuir
                  propriedades específicas ou funcionais, compostas por
                  ingredientes ou matérias-primas e aditivos destinados
                  exclusivamente à alimentação de animais de companhia. Além
                  desses, estamos iniciando com a produção dos lickables que tem
                  intuito de trazer um novo conceito de snacks para os felinos e
                  tem uma procura muito grande de nossos parceiros e clientes.
                </p>
              </Card.Body>
            </Card>
          </Col>
